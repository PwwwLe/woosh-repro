"""Woosh-Flow 官方 text-to-audio 推理脚本。

脚本加载 ``LatentDiffusionModel``，构造 ``[B, 128, 501]`` Gaussian latent
noise，使用文本 conditioner 生成 cross-attention 条件，经 ODE sampler 得到
latent，再调用 Woosh-AE ``inverse`` 写出 wav。
"""
