"""底层 1D autoencoder 与 VAE 使用的卷积/注意力 building blocks。"""
...
class ResnetBlock(nn.Module):
    """1D ResNet block，可选时间 embedding 调制。"""
